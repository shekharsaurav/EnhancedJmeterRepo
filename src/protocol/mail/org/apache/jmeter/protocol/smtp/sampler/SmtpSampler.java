...
import org.apache.jmeter.protocol.smtp.config.gui.*;
...
public class SmtpSampler extends AbstractSampler {
    ...
    //public static final String RECEIVER_TO          = "shekhar@localhost"; // $NON-NLS-1$
    ...
    public SampleResult sample(Entry e) {
        ...
        SmtpPanel smtppanel = new SmtpPanel();
        smtppanel.setReceiverTo("shekhar@localhost");
